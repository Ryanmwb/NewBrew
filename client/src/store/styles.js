const styles = [
  ...
  },
  {
    ...
    category: {
      ...
      description:
        'Malternative Beverages, also known as "ready-to-drink" beverages, are sweet, sometime carbonated, beverages that are low in alcohol.',
